...
- Log all activity to `C:\portable\startupscript\app_monitor.log`
...
4. Check the log file to confirm:
   ```
   type C:\portable\startupscript\app_monitor.log
   ```
...
A: This usually means the setup script wasn't run as Administrator. Try again:
   ...
   - Then execute: `cd C:\portable\startupscript && setup_monitor_task.bat`
